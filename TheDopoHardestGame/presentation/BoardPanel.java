...
public class BoardPanel extends JPanel {
    ...
    private java.util.List<DrawCommand> drawCommands = new java.util.ArrayList<>();
    ...
    public void setDrawCommands(java.util.List<DrawCommand> cmds) {
